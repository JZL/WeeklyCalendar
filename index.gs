...
//  var thisMonday = getMonday(new Date("4/22/2017"))
...
//    body.appendParagraph(getTasks().concat(starredToTask(), todoCal()).sort().join("\n")).setFontFamily("Droid Sans Mono").setFontSize(8)
